...
export default function RequestCard({
  ...
  return (
    <div
  className={`sun-card sun-card--review rounded-2xl p-6 flex flex-col gap-4 border border-violet-100/40
...
>
  ...
  <div>
    ...
    <p className="flex mt-1 text-sm pl-9 text-gray-700">
      ...
      <div className="bg-[#efe8f8] border border-white/60 p-3 rounded-2xl flex flex-col gap-2 text-sm">
  ...
  <div className="flex gap-2">
    <button onClick={onAccept} className="flex-1 bg-violet-600 text-white py-2 rounded-2xl font-semibold hover:bg-violet-700 transition">
      Accept
    </button>
    <button onClick={onDecline} className="flex-1 border border-violet-200 bg-white py-2 rounded-2xl font-semibold text-violet-700 hover:bg-violet-50 transition">
      Decline
    </button>
  </div>
